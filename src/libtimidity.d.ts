declare class LibtimidityCalls {
    ccall(fn: "mid_get_version", retType: "number", argTypes: void[], args: void[]): void;
    ccall(fn: "mid_init", retType: "number", argTypes: ["string"], args: [string]): void;
    ccall(fn: "mid_init_no_config", retType: "number", argTypes: void[], args: void[]): void;
    ccall(fn: "mid_exit", retType: null, argTypes: void[], args: void[]): void;
    ccall(fn: "mid_istream_open_mem", retType: "number", argTypes: ["number", "number"], args: [number, number]): number;
    ccall(fn: "mid_istream_close", retType: "number", argTypes: ["number"], args: [number]): number;
    ccall(fn: "mid_song_load", retType: "number", argTypes: ["number", "number"], args: [number, number]): number;
    ccall(fn: "mid_song_set_volume", retType: null, argTypes: ["number", "number"], args: [number, number]): void;
    ccall(fn: "mid_song_start", retType: null, argTypes: ["number"], args: [number]): void;
    ccall(fn: "mid_song_read_wave", retType: "number", argTypes: ["number", "number", "number"], args: [number, number, number]): number;
    ccall(fn: "mid_song_seek", retType: null, argTypes: ["number", "number"], args: [number, number]): void;
    ccall(fn: "mid_song_get_total_time", retType: "number", argTypes: ["number"], args: [number]): number;
    ccall(fn: "mid_song_get_time", retType: "number", argTypes: ["number"], args: [number]): number;
    ccall(fn: "mid_song_free", retType: null, argTypes: ["number"], args: [number]): void;
    ccall(fn: "mid_alloc_options", retType: "number", argTypes: ["number", "number", "number", "number"], args: [number, number, number, number]): number;
    ccall(fn: "mid_get_load_request", retType: "string", argTypes: ["number", "number"], args: [number, number]): string;
    ccall(fn: "mid_get_load_request_count", retType: "number", argTypes: ["number"], args: [number]): number;
...
declare class Libtimidity extends LibtimidityCalls {
...
declare function _loadLibtimidity(): Libtimidity;
export = _loadLibtimidity;